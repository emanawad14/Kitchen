    ...
    <div className="bg-gray-100 py-12">
      <div className="container mx-auto px-4">
        ...
        <p className="text-center text-gray-600 max-w-2xl mx-auto mb-10">
           فريق "تـعـلـب كـتـشـن" مستعد لمساعدتك!
          يمكنك بسهولة التواصل معنا عبر مواقع التواصل التالية للحصول على استشارة مجانية
          وعرض سعر مخصص.
        </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
          ...
          <div className="bg-white p-6 rounded-xl shadow-md">
            ...
            <p className="text-gray-700">01063708830</p>
            <p className="text-gray-700">01063708830</p>
          ...
          <div className="bg-white p-6 rounded-xl shadow-md">
            ...
            <p className="text-gray-700">برج النور الحمص  __اجا </p>
            <p className="text-gray-500 text-sm mt-1">طريق اجا __برج النور الحمص</p>
          </div>
        </div>
      </div>
    </div>
